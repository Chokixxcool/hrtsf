...
void makeSFTemplates_V2(TString object, TString algo, TString wp, TString ptrange, TString syst, bool pass, TString mistRate, float WP_Top_binarized, float WP_Top_binarizedMD, float WP_Top_raw, float WP_Top_rawMD, int year, TString workdir) {
